...
class PlayerAI:
    ...
    def do_move(self, world, enemy_units, friendly_units):
        ...
        pickup_bonuses = [1, 0, 1, 1, 1, 1]
        pickup_bonuses = [random.randint(1,100), random.randint(1,100), random.randint(1,100), random.randint(1,100), random.randint(1,100), random.randint(1,100) ]
        combat_bonus = {"dmg": random.randint(1,100),
                "rng": random.randint(1,100),
                "hp": random.randint(1,100)}
        bonus = {"friend": random.randint(1,100),
